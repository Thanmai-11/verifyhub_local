...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-verifyhub-default-dev-key')
...
WSGI_APPLICATION = 'verifyhub.wsgi.application'
...
if os.getenv('DATABASE_URL'):
    DATABASES['default'] = dj_database_url.config(
        conn_max_age=0,  # changed from 600 to 0 to prevent stale connections
        ssl_require=True
    )
# Optional: Add password validation back in production
